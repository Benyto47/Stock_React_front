...
function UpdateStock() {
  ...
  axios
   .get(`http://localhost:8181/stock/articles/${stockId}`)
   .then((response) => {
    // notifySuccess();
  ...
  const postApvment = () => {
    ...
    axios
      .put("http://localhost:8181/stock/articles", {
        id : article.id,
        nom: article.nom,
        image : article.image,
        descp: article.descp,
  ...
  return (
    <div className="shadow-lg shadow-blue-700 mb-5 mt-[2rem] ms-[16rem] px-5 bg-white rounded-lg">
      <div className="mt-3 w-[500px] mx-auto  p-3">
        <div>
          <h1 className="uppercase font-mono font-semibond text-2xl font-bold">
            Modifier l'article en stock
          </h1>
          ...
          <form method="post" onSubmit={handleSubmit}>
            ...
            <div className="mt-10 relative">
              ...
              >
                <option value="">{article&& article.category&& article.category.nom}</option>
                {categoriesMap &&
